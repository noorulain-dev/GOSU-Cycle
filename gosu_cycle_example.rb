...
# Add a shape_x variable in the following (similar to the cycle 
# one)
# that is initialised to zero then incremented by at least 2 or more in update.
...
class GameWindow < Gosu::Window
  ...
  def initialize
    ...
    @background_image = Gosu::Image.new("media/earth.jpg")
  ...
  def draw
	...
	Gosu.draw_rect(@shape_x, 200, 100, 50, Gosu::Color::BLUE, ZOrder::TOP, mode=:default)
    puts "2. In draw\n"
  end
end
